-- Addition to rafta.lua module
-- Add this function to the existing M table in /home/master/Workspace/plugins/rafta.nvim/lua/rafta.lua
...
-- getAllTasks function for testing purposes
-- @return table containing all tasks or error
M.getAllTasks = function()
  local success, result = pcall(function()
    return vim.fn.rpcrequest(grpc.remote(), "GetAllTasks", {})
  end)
  
  if not success then
    error("Failed to get all tasks: " .. tostring(result))
  end
